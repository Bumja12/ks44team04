...
public class AlertSend {
	...
	public String toString() {
		return "AlertSend{" + "alertSend='" + alertSend + '\'' + ", alertCode='" + alertCode + '\'' + ", receiveId='"
				+ receiveId + '\'' + ", sendId='" + sendId + '\'' + ", receiveDate='" + receiveDate + '\''
				+ ", sendDate='" + sendDate + '\'' + ", alertInfo=" + alertInfo + '}';
	}
}
